...
public class BottomSheet<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public abstract static class BottomSheetCallback {
         ...
         */
        public abstract void onStateChanged(@NonNull View bottomSheet, @BottomSheet.State int newState);
    ...
    private BottomSheet.SettleRunnable settleRunnable = null;
    ...
    @NonNull private final ArrayList<BottomSheet.BottomSheetCallback> callbacks = new ArrayList<>();
    ...
    public Parcelable onSaveInstanceState(@NonNull CoordinatorLayout parent, @NonNull V child) {
        return new BottomSheet.SavedState(super.onSaveInstanceState(parent, child), this);
    }

    @Override
    public void onRestoreInstanceState(
            @NonNull CoordinatorLayout parent, @NonNull V child, @NonNull Parcelable state) {
        BottomSheet.SavedState ss = (BottomSheet.SavedState) state;
     ...
     */
    public void setSaveFlags(@BottomSheet.SaveFlags int flags) {
     ...
     * @deprecated use {@link #addBottomSheetCallback(BottomSheet.BottomSheetCallback)} and {@link
     *     #removeBottomSheetCallback(BottomSheet.BottomSheetCallback)} instead
     */
    @Deprecated
    public void setBottomSheetCallback(BottomSheet.BottomSheetCallback callback) {
        Log.w(
                TAG,
                "BottomSheet now supports multiple callbacks. `setBottomSheetCallback()` removes"
     ...
     * @param callback The callback to notify when bottom sheet events occur.
     */
    public void addBottomSheetCallback(@NonNull BottomSheet.BottomSheetCallback callback) {
     ...
     */
    public void removeBottomSheetCallback(@NonNull BottomSheet.BottomSheetCallback callback) {
     ...
     */
    public void setState(@BottomSheet.State int state) {
        if (state == this.state) {
            return;
        }
        if (viewRef == null) {
    ...
    private void settleToStatePendingLayout(@BottomSheet.State int state) {
    ...
    void setStateInternal(@BottomSheet.State int state) {
        if (this.state == state) {
            return;
        }
        this.state = state;
    ...
    private void updateDrawableForTargetState(@BottomSheet.State int state) {
        if (state == STATE_SETTLING) {
    ...
    private void restoreOptionalState(@NonNull BottomSheet.SavedState ss) {
    ...
    void startSettlingAnimation(View child, int state, int top, boolean settleFromViewDragHelper) {
        ...
        if (startedSettling) {
            ...
            if (settleRunnable == null) {
                ...
                settleRunnable = new BottomSheet.SettleRunnable(child, state);
            }
    ...
    private final ViewDragHelper.Callback dragCallback =
            new ViewDragHelper.Callback() {
                ...
                public void onViewReleased(@NonNull View releasedChild, float xvel, float yvel) {
                    int top;
                    @BottomSheet.State int targetState;
                    if (yvel < 0) { // Moving up
                        /*if (fitToContents) {
                            top = fitToContentsOffset;
                            targetState = STATE_EXPANDED;
                        ...
                        int currentTop = releasedChild.getTop();
                        if (currentTop > BottomSheet.this.halfExpandedOffset) {
                            top = BottomSheet.this.halfExpandedOffset;
                            targetState = 6;
                        } else {
                            top = 0;
                            targetState = 3;
    ...
    private class SettleRunnable implements Runnable {
        ...
        SettleRunnable(View view, @BottomSheet.State int targetState) {
            this.view = view;
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull BottomSheet<?> behavior) {
            super(superState);
        ...
        /**
         * This constructor does not respect flags: {@link BottomSheet#SAVE_PEEK_HEIGHT}, {@link
         * BottomSheet#SAVE_FIT_TO_CONTENTS}, {@link BottomSheet#SAVE_HIDEABLE}, {@link
         * BottomSheet#SAVE_SKIP_COLLAPSED}. It is as if {@link BottomSheet#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link #SavedState(Parcelable, BottomSheet)} instead.
         */
        @Deprecated
        ...
        public static final Creator<BottomSheet.SavedState> CREATOR =
                new ClassLoaderCreator<BottomSheet.SavedState>() {
                    @NonNull
                    @Override
                    public BottomSheet.SavedState createFromParcel(@NonNull Parcel in, ClassLoader loader) {
                        return new BottomSheet.SavedState(in, loader);
                    }

                    @Nullable
                    @Override
                    public BottomSheet.SavedState createFromParcel(@NonNull Parcel in) {
                        return new BottomSheet.SavedState(in, null);
                    }

                    @NonNull
                    @Override
                    public BottomSheet.SavedState[] newArray(int size) {
                        return new BottomSheet.SavedState[size];
                    }
                };
    }
    ...
    public static <V extends View> BottomSheet<V> from(@NonNull V view) {
        ...
        if (!(behavior instanceof BottomSheet)) {
            throw new IllegalArgumentException("The view is not associated with BottomSheet");
        }
